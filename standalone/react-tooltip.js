...
},{"./customEvent":4}],4:[function(require,module,exports){
'use strict';
...
var ReactTooltip = (0, _staticMethods2.default)(_class = (0, _windowListener2.default)(_class = (0, _customEvent2.default)(_class = (0, _isCapture2.default)(_class = (0, _getEffect2.default)(_class = (0, _bodyMode2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  bodyMode: _react.PropTypes.bool,
  possibleCustomEvents: _react.PropTypes.string,
  possibleCustomEventsOff: _react.PropTypes.string
...
},{"./decorators/bodyMode":3,"./decorators/customEvent":4,"./decorators/getEffect":5,"./decorators/isCapture":6,"./decorators/staticMethods":7,"./decorators/windowListener":8,"./style":10,"./utils/aria":11,"./utils/getPosition":12,"./utils/getTipContent":13,"./utils/nodeListToArray":14,"classnames":1}],10:[function(require,module,exports){
'use strict';
